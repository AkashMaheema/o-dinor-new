...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <div
      ...
      style="background-image: url('images/check-out.jpg')"
    >
      <div class="container">
        <div
        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              ...
              <p>
                explantion explantion explantion explantion explantion
                explantion
              </p>
              <ul
              ...
              <div class="block-23 mb-3">
                <ul>
                  <li>
                    ...
                    ><span class="text"
                      >Address. Address, Address, Address, Country</span
                    >
                  </li>
                  <li>
                    <a href="#"
                      ><span class="icon icon-phone"></span
                      ><span class="text">+94 111 1111 111</span></a
                    >
                  </li>
                  <li>
                    <a href="#"
                      ><span class="icon icon-envelope"></span
                      ><span class="text">Bhanuka@kalu.com</span></a
                    >
                  </li>
                </ul>
              </div>
